...
class Promos extends Section
{
    ...
    public function onDisplay()
    {
        ...
        return AdminDisplay::datatables()
            ...
            ->setColumns([
                ...
                AdminColumn::text('name', 'Name')->setWidth('450px'),
                AdminColumn::text('discount', 'Discount')->setWidth('30px'),
                AdminColumn::lists('groups.name', 'Groups')->setWidth('150px'),
            ])->paginate(20);
    }
    ...
    public function onEdit($id)
    {
        ...
        return  $panel->addBody([
            ...
            AdminFormElement::multiselect('groups', 'Groups',Group::class)->setDisplay('name'),
        ]);
    }
